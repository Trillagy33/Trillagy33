...
const PeopleSearch = () => {
    ...
    // Filter options
    const filterOptions = {
        titles: ['CEO', 'CTO', 'CFO', 'VP', 'Director', 'Manager','HR','Recruitment'],
    ...
    return (
        <div className="people-search-page">
            <div className="search-header">
                ...
                <button className="search-btn" onClick={searchPeople} disabled={loading}>
                        ...
                        <div className="filter-section">
                            ...
                            <label className="filter-option">
                                <input
                                    ...
                                    onChange={() => handleFilterChange('emailVerified', !filters.emailVerified)}
                                />
