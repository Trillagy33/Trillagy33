...
import { FaSearch, FaBuilding, FaUser, FaArrowRight } from 'react-icons/fa';
      ...
      <main className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Access comprehensive information about individuals and businesses instantly
          </p>
        ...
        <div className="features-content">
          ...
          <div className="feature-cards">
            <div className="feature-card">
              ...
              <p>Get precise and up-to-date information every time you search</p>
            </div>
            <div className="feature-card">
              <div className="icon">⚡</div>
              <h3>Fast Search</h3>
